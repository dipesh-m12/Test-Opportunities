      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between gap-7 p-2">
        ...
        >
          <div>
            ...
            <Link to="https://www.inovact.in/about">
              <h3 className="hover:text-gray-300 text-sm sm:text-base transition-colors">
                About Us
              </h3>
            </Link>
            <Link to="https://inovact-opportunity.vercel.app/" target="_blank">
              <h3 className="hover:text-gray-300 text-sm sm:text-base transition-colors">
                Opportunities
              </h3>
            </Link>
          ...
          <div>
            ...
            <Link to="https://www.inovact.in/terms-of-use">
              <h3 className="hover:text-gray-300 text-sm sm:text-base transition-colors cursor-pointer">
                Terms of use
              </h3>
            </Link>
            <Link to="https://www.inovact.in/privacy-policy">
              <h3 className="hover:text-gray-300 text-sm sm:text-base transition-colors cursor-pointer">
                Privacy policy
              </h3>
            </Link>
      ...
      <div className="max-w-7xl mx-auto items-center justify-center mt-10">
        <motion.div variants={fadeInUpVariants}>
          ...
          <div className="flex items-center justify-center gap-10 flex-wrap">
            <Link
              to="https://chat.whatsapp.com/GClxUdUctuaEUeWmJmNYHo"
              target="_blank"
            >
              <img
                src="/images/33.svg"
            ...
            <Link
              to="https://www.instagram.com/inovact__/?utm_medium=copy_link"
              target="_blank"
            >
              <img
                src="/images/34.svg"
            ...
            <Link
              to="https://www.linkedin.com/company/inovact-pvt-ltd2/mycompany/"
              target="_blank"
            >
              <img
                src="/images/35.svg"
